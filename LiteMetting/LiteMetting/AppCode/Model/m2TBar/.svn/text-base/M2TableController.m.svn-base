...
#import "M2TableController.h"
#import "EEUIFactory.h"
#import "Tools_GetAllModalListConfig.h"
#import "ListGeneralModal.h"

@interface M2TableController ()

@end

@implementation M2TableController
...
- (void)viewDidLoad
{
    ...
    self.modalConfig = [[Tools_GetAllModalListConfig shareInstance] ee_getOneConfigByMarkID:MarkID_MeetSchedul];
